            ...
            GameApi.onGameOver = function (data) {
                if (data.hasNewPlayer == 1) {
                    ...
                    egret.setTimeout(function () {
                        cgcp.Log.log("获得带新人奖励 房卡2张");
                        cgcp.TipPanel.create("获得带新人奖励 房卡2张", null, null);
                    }, this, 300);
                }
            };
            return GameApi;
        ...
        var AssetManager = (function () {
            ...
            AssetManager.initWithStart = function (callBack, callBackThisObj) {
                ...
                if (AssetManager.is_local) {
                    ...
                    cgcp.AppConfig.platform_res_url = "http://192.168.2.188/aptana/cgc_platform/resource/";
                    AssetManager.loadConfig("http://192.168.2.188/aptana/cgc_platform/resource/default.res.json", "http://192.168.2.188/aptana/cgc_platform/resource/", callBack, callBackThisObj, cgcp.AccountData.getUrlData().resVer);
                }
            };
            /**
             * 加载资源配置
...
(function (lj) {
    ...
    (function (cgcp) {
        ...
        /** 游戏列表 */
        AppConfig.gameList = "http://192.168.2.188/aptana/cgc_platform/gameList.php";
        /** 支付地址 */
        AppConfig.pay_path = "http://poker.sh-lingjing.com/cgc_server/pay/startPay.php";
        /** 登录地址 */
        AppConfig.login_path = "http://poker.sh-lingjing.com/cgc_server/cgcplatform_index.php";
        /** 网络资源路径  */
        AppConfig.web_res_path = "http://poker.sh-lingjing.com/cgc_client/";
        /** 服务器ip */
        AppConfig.server_host = "192.168.2.188";
        /** 服务器端口 */
        AppConfig.server_port = 7502;
        /** 平台资源配置地址 */
        ...
        /** 微信jssdk配置地址 */
        AppConfig.wx_jssdk_config_path = "http://poker.sh-lingjing.com/cgc_server/wxJsSdkConfig.php";
        /** 登录账号 */
        AppConfig.account = "";
        /** 代理后台主类 */
...
(function (lj) {
    var cgcp;
    (function (cgcp) {
        var MatchBase = (function (_super) {
            __extends(MatchBase, _super);
            function MatchBase() {
                return _super.call(this) || this;
            }
            return MatchBase;
        }(egret.DisplayObjectContainer));
        cgcp.MatchBase = MatchBase;
    })(cgcp = lj.cgcp || (lj.cgcp = {}));
})(lj || (lj = {}));
var lj;
(function (lj) {
    ...
    (function (cgcp) {
        ...
        var BuyCardFromProxy = (function (_super) {
            ...
            BuyCardFromProxy.prototype.on_buyBtn = function (e) {
                ...
                var thisObj = this;
                var par = {};
                par["openid"] = cgcp.AppConfig.account; //AccountData.getUser().account;
    ...
    (function (cgcp) {
        var MainPanelGameBtn = (function (_super) {
            ...
            MainPanelGameBtn.prototype.onClicnEvent = function (e) {
                if (this.gameConf.matchClass != null) {
                    this.loadMatchAssets();
                    return;
                }
                if (this.gameConf.jump_url != null) {
                    window.location.href = this.gameConf.jump_url;
                    return;
                }
             ...
             * 加载比赛资源
             */
            MainPanelGameBtn.prototype.loadMatchAssets = function () {
                if (!RES.isGroupLoaded("match_res")) {
                    cgcp.NetworkLoading.show(true);
                    cgcp.AssetManager.loadConfig(this.gameConf.matchResConfigUrl, this.gameConf.matchResUrl, this.loadMatchResConfigComplete, this);
                }
                else {
                    this.showMatch();
                }
             ...
             * 比赛资源配置加载成功
             */
            MainPanelGameBtn.prototype.loadMatchResConfigComplete = function (data) {
                cgcp.AssetManager.loadGroup("match_res", this.loadMatchAssetComplete, this);
            };
            /**
             * 比赛资源加载成功
             */
            MainPanelGameBtn.prototype.loadMatchAssetComplete = function (data) {
                var callBackType = data[0];
                var e = data[1];
                if (callBackType == "onResourceLoadComplete") {
                    cgcp.NetworkLoading.hide();
             ...
             * 显示比赛面板
             */
            MainPanelGameBtn.prototype.showMatch = function () {
                var clazz = egret.getDefinitionByName(this.gameConf.matchClass);
                var matchPanel = new clazz();
                lzm.Alert.alert(matchPanel);
            };
